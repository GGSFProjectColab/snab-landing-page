      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="relative mx-4 border-x border-dotted border-edge">
          ...
          <div className="grid grid-cols-1 gap-0 border-b border-dotted border-edge md:grid-cols-[1fr_2fr]">
            {/* Brand section */}
            <div className="footer-brand-cell relative flex flex-col gap-4 border-b border-dotted border-edge p-4 sm:p-6 md:border-b-0 md:border-r">
              <a
            ...
            {/* Navigation columns */}
            <nav className="grid grid-cols-2 gap-0 border-b border-dotted border-edge md:grid-cols-4" aria-label="Footer navigation">
              {footerColumns.map((column, colIdx) => (
                <div
                  className={`flex flex-col gap-3 border-b border-dotted border-edge p-4 sm:p-6 last:border-b-0 ${
                    colIdx < footerColumns.length - 1 ? "md:border-r md:border-b-0" : ""
