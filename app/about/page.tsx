        ...
        <ContainerWrapper>
          <div className="relative min-h-[340px] overflow-hidden sm:min-h-[400px]">
            ...
            <div className="relative z-10 flex min-h-[340px] flex-col justify-end p-6 sm:min-h-[400px] sm:p-10 md:p-14">
              <p className="mb-4 font-mono text-caption uppercase tracking-widest text-white/80">
                About us
              </p>
              <h1
                id="about-title"
                className="max-w-3xl text-display font-normal text-white"
              >
        ...
        <ContainerWrapper>
          ...
          <div className="grid gap-0 border-b border-dotted border-edge md:grid-cols-2">
            <div className="flex flex-col justify-center border-b border-dotted border-edge p-6 sm:p-8 md:border-b-0 md:border-r md:p-10">
              ...
              <h2 className="mb-4 text-subheading font-normal">
              ...
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  <li
                    ...
                    key={principle}
                  >
                    <span className="mt-0.5 font-mono text-caption text-foreground/60">
                      0{i + 1}
                    </span>
                    {principle}
                  </li>
              ...
              <ul className="space-y-3">
                {capabilities.map((cap, i) => (
                  <li
                    ...
                    key={cap}
                  >
                    <span className="font-mono text-caption text-foreground/60">
                      0{i + 1}
                    </span>
                    {cap}
                  </li>
        ...
        <ContainerWrapper>
          ...
          <div className="grid gap-0 border-b border-dotted border-edge md:grid-cols-2">
            <div className="flex flex-col justify-center border-b border-dotted border-edge p-6 sm:p-8 md:border-b-0 md:border-r md:p-10">
              ...
              <h2 className="mb-6 text-subheading font-normal">
            ...
            {products.map((product) => (
              ...
              >
                <div className="flex flex-col justify-center p-6 sm:p-8 md:p-10">
                  ...
                  <a
                    className="mt-4 inline-flex w-max items-center gap-1.5 text-button font-normal text-foreground/60 transition-colors hover:text-foreground"
                    href="/work"
                  >
                    View work
        ...
        <ContainerWrapper>
          <div className="relative min-h-[240px] overflow-hidden sm:min-h-[280px]">
            ...
            <div className="relative z-10 flex h-full flex-col items-start justify-center gap-4 p-6 sm:items-center sm:text-center sm:py-10 md:px-12">
              ...
              <a
                className="border border-white/30 bg-transparent px-5 py-2.5 text-button font-normal text-white transition-all hover:bg-white hover:text-black"
                href="/contact"
              >
