...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col justify-between">
      <section className="flex-1 flex flex-col justify-center py-2 sm:py-4">
        <ContainerWrapper>
          <div className="flex flex-col items-center justify-center px-4 pt-2 pb-6 sm:pt-4 sm:pb-8 md:pt-4 md:pb-10 text-center">
            {/* Retro TV 404 graphic */}
            <div className="w-full flex items-center justify-center overflow-visible">
              <div className="scale-[0.75] xs:scale-[0.85] sm:scale-95 md:scale-100 origin-center transition-transform duration-300">
                <RetroTvError errorCode="404" errorMessage="NOT FOUND" />
              </div>
            </div>

            {/* Message Content */}
            <div className="mt-1 max-w-lg space-y-2">
