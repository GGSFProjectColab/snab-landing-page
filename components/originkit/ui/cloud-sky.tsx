...
export default function CloudSky(props: Props) {
    ...
    useEffect(() => {
        ...
        const render = (now: number) => {
            // Cap at ~30fps: clouds are slow-moving, halves GPU cost vs 60fps
        ...
        // Cursor assist fully off when parallax + wind are 0 — no pointer tracking at all
        const pointerOff =
            (vRef.current.parallax as number) === 0 && (vRef.current.wind as number) === 0
